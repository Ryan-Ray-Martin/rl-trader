...
class State:
    ...
    def encode(self):
        ...
        for bar_idx in range(-self.bars_count+1, 1):
            ...
            shift += 1
            res[shift] = self._prices.negative[ofs]
            shift += 1
            res[shift] = self._prices.neutral[ofs]
            shift += 1
            res[shift] = self._prices.positive[ofs]
            shift += 1
            res[shift] = self._prices.compound[ofs]
            shift += 1
            res[shift] = self._prices.ret_300_tech[ofs]
            shift += 1
            res[shift] = self._prices.ret_600_tech[ofs]
            shift += 1
            res[shift] = self._prices.ret_1260_tech[ofs]
            shift += 1
            res[shift] = self._prices.rsi_tech[ofs]
            shift += 1
            res[shift] = self._prices.atr_tech[ofs]
            shift += 1
            if self.volumes:
...
class State1D(State):
    ...
    def encode(self):
        ...
        res[3] = self._prices.negative[start:stop]
        res[4] = self._prices.neutral[start:stop]
        res[5] = self._prices.positive[start:stop]
        res[6] = self._prices.compound[start:stop]
        res[9] = self._prices.ret_300_tech[start:stop]
        res[10] = self._prices.ret_600_tech[start:stop]
        res[11] = self._prices.ret_1260_tech[start:stop]
        res[12] = self._prices.rsi_tech[start:stop]
        res[14] = self._prices.atr_tech[start:stop]
        if self.volumes:
            res[17] = self._prices.volume[start:stop]
            dst = 13
        else:
            dst = 12
